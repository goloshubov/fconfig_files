...
alias grep_f_dgrey='GREP_COLORS="ms=01;30" grep --color=always'
alias grep_f_red='GREP_COLORS="ms=01;31" grep --color=always'
alias grep_f_red_blink='GREP_COLORS="ms=05;31;40" grep --color=always'
alias grep_f_green='GREP_COLORS="ms=01;32" grep --color=always'
alias grep_f_yellow='GREP_COLORS="ms=01;33" grep --color=always'
alias grep_f_blue='GREP_COLORS="ms=01;34" grep --color=always'
alias grep_f_purple='GREP_COLORS="ms=01;35" grep --color=always'
alias grep_f_teal='GREP_COLORS="ms=01;36" grep --color=always'
alias grep_f_lgrey='GREP_COLORS="ms=01;37" grep --color=always'
