...
FCONFIG_WS='ansible-playbook -i ~/git/github/fconfig/hosts_workstations ~/git/github/fconfig/workstation.yml -e ansible_connection=local --limit $(hostname)'
FCONFIG_SERVER='ansible-playbook -i ~/git/github/fconfig/hosts_workstations ~/git/github/fconfig/server.yml -e ansible_connection=local --limit $(hostname)'
