...
FCONFIG_WS='ansible-playbook -i ~/git/github/fconfig/inventory ~/git/github/fconfig/workstation.yml -e ansible_connection=local --limit $(hostname)'
FCONFIG_SERVER='ansible-playbook -i ~/git/github/fconfig/inventory ~/git/github/fconfig/server.yml -e ansible_connection=local --limit $(hostname)'
